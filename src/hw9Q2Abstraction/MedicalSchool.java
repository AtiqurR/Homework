 ...
 * Ans:2 keywords.
 * 
 * An Abstract Class can inherit only one Abstract Class or a regular class by
 * extends keyword.
 * 
 * But An Abstract class can inherit interface by implements keyword more than
